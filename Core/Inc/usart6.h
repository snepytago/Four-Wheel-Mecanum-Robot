...
// --- RX: nhan lenh dieu khien tu 1 ESP32 khac qua PC7 (USART6_RX) ---
// Goi usart6_rx_init() 1 lan, SAU usart6_init(), luc khoi dong. Hien main.c
// CHUA doc/parse cac dong nhan duoc - ha tang de san sang tich hop sau nay.
